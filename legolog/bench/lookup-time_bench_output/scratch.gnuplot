...
set key box
set output "agg-false-lookup.pdf"
set datafile separator ','
set ylabel "Time taken (ms)"
set xlabel "Update periods/verification period"
set xrange[0:1000]
set xtics 0,200,1000
plot "1-partitions_agg-false_lookup_times.csv" using 1:2 skip 1 with lines lw 3 title "1 partition", \
     ...
     "8-partitions_agg-false_lookup_times.csv" using 1:2 skip 1 with lines lw 3 title "8", \
     ...
     "64-partitions_agg-false_lookup_times.csv" using 1:2 skip 1 with lines lw 3 title "64", \
